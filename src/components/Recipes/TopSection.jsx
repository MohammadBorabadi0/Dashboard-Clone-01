const TopSection = () => {
  return (
    <section className="flex flex-col lg:flex-row gap-16 lg:gap-0 items-center justify-between mt-10">
      <div className="flex flex-col md:flex-row items-center gap-6">
        <img src="./img/icons/chicken.svg" className="w-24" />
        <div className="flex flex-col items-center gap-3 pt-2">
          <h4 className="flex text-xl lg:text-3xl gap-1 text-slate-700 font-secondary">
